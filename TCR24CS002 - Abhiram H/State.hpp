...
// A single point in the finite Cartesian state space R^d.
class State {
public:
    uint64_t id;
    ...
    // Euclidean distance between two states. Used for the heuristic
    // and for the "distance to nearest bad state" safety metric.
