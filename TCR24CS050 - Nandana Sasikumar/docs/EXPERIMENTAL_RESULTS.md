...
| Grid Dimension | States ($\vert V \vert$) | Transitions ($\vert E \vert$) | Bad States ($\vert \mathcal{B} \vert$) | Vertex Expansions | Initial Time (ms) | Planner Memory (KB) | Process RSS (KB) |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
